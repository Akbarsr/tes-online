...
<body class="container mt-4">
    <h2 class="mb-3">Stock Out</h2>
    <a href="<?= site_url('stockout/create') ?>" class="btn btn-primary mb-3">+ Add Stock Out</a>
...
$(document).ready(function() {
    var table = $('#stockOutTable').DataTable({
        ...
        "fixedHeader": true,
        "ajax": {
            "url": "<?= site_url('stockout/get_stockout') ?>",
            "type": "POST"
        },
    });

    // filter per kolom
    $('#stockOutTable thead tr:eq(1) th').each(function (i) {
